...
def date_veiculo(numero, plates):
    if numero in plates:
        ...
        for row in records:
            ...
            print("idVeiculo: " , idCarros, "Veiculo: " , placa)
            if (placa == numero) and (dataSaida == None)and (dataEntrada != None):
                print("e igual salva tabela saida")
        ...
        for row in records:
            ...
            print("idVeiculo: " , idCarros, "Veiculo: " , placa)
            if (placa == numero):
                print("e diferente salva tabela entrada")
